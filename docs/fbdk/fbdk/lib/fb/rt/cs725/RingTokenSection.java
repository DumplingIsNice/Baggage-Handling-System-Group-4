...
import fb.rt.*;
import fb.rt.events.*;
/** FUNCTION_BLOCK RingTokenSection
  * @author JHC
  * @version 20221018/JHC
  */
public class RingTokenSection extends FBInstance
{
/** VAR Candidate */
 ...
 */
  public void connect_Candidate(BOOL newIV) throws FBRManagementException{
    Candidate = newIV;
    Conveyor4.connectIVNoException("Candidate",Candidate);
    }
 ...
 */
  public void connect_Block(BOOL newIV) throws FBRManagementException{
    Block = newIV;
    Conveyor4.connectIVNoException("Block",Block);
    }
 ...
 */
  public void connect_PE(BOOL newIV) throws FBRManagementException{
    PE = newIV;
    Conveyor4.connectIVNoException("PE",PE);
    }
 ...
 */
  public void connect_PE13(BOOL newIV) throws FBRManagementException{
    PE13 = newIV;
    Conveyor4.connectIVNoException("PE13",PE13);
    }
/** FB FC11 */
  protected ConveyorCTL FC11 = new ConveyorCTL() ;
/** FB Conveyor4 */
  protected Conveyor_4 Conveyor4 = new Conveyor_4() ;
/** The default constructor. */
public RingTokenSection(){
    super();
    INIT.connectTo(FC11.INIT);
    REQ.connectTo(FC11.REQ);
    Conveyor4.INITO.connectTo(INITO);
    Conveyor4.CNF.connectTo(CNF);
    REQ.connectTo(Conveyor4.REQ);
    Conveyor4.STOP.connectTo(FC11.CAS_STOP);
    Conveyor4.START.connectTo(FC11.CAS_START);
    FC11.INITO.connectTo(Conveyor4.INIT);
    RToken.connectTo(Conveyor4.RToken);
    Conveyor4.GToken.connectTo(GToken);
    Conveyor4.connectIVNoException("Block",Block);
    Conveyor4.connectIVNoException("Candidate",Candidate);
    Conveyor4.connectIVNoException("PE",PE);
    BlockCon = (BOOL)Conveyor4.ovNamedNoException("BlockCon");
    MotoRotate1 = (BOOL)FC11.ovNamedNoException("MotoRotate");
    MotoRotate2 = (BOOL)Conveyor4.ovNamedNoException("MotoRotate");
    Conveyor4.connectIVNoException("PE13",PE13);
 ...
 * @throws FBRManagementException {@inheritDoc} */
  ...
  throws FBRManagementException{
    ...
    Conveyor4.initialize("Conveyor4",r);
}
