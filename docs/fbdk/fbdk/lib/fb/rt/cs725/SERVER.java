...
/** Services the REQ_F_C2 event. */
  public void service_REQ_F_C2(){
    ...
    else if ((eccState == index_START)) state_GIVE_C2_TOKEN();
  }
...
/** Services the REQ_F_C6 event. */
  public void service_REQ_F_C6(){
    ...
    else if ((eccState == index_START)) state_GIVE_C6_TOKEN();
  }
...
PRIORITY.value = false;
  ...
  /** ALGORITHM BAG_CLEARED IN Java*/
public void alg_BAG_CLEARED(){
System.out.println("---------------");
System.out.println("BAG HAS LEFT CS 1");
System.out.println(C2_FLAG.value);
System.out.println(C6_FLAG.value);
